...
var or__21670__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__21670__auto__)){
return or__21670__auto__;
} else {
var or__21670__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__21670__auto____$1)){
return or__21670__auto____$1;
} else {
var or__21670__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__21670__auto____$2)){
return or__21670__auto____$2;
} else {
var or__21670__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__21670__auto____$3)){
return or__21670__auto____$3;
} else {
...
var n__22573__auto__ = a.length;
var i = (0);
while(true){
if((i < n__22573__auto__)){
var c_23212 = (a[i]);
if(cljs.core.truth_((c_23212["cljsIsDirty"]))){
(c_23212["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__22268__auto__,writer__22269__auto__,opt__22270__auto__){
return cljs.core._write.call(null,writer__22269__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__23216 = c;
var G__23216__$1 = (((G__23216 == null))?null:(G__23216["props"]));
if((G__23216__$1 == null)){
return null;
} else {
return (G__23216__$1["argv"]);
}
});
...
var G__23218_23219 = (c["cljsRatom"]);
if((G__23218_23219 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__23218_23219);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1457989971025