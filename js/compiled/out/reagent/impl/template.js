...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__22268__auto__,writer__22269__auto__,opt__22270__auto__){
return cljs.core._write.call(null,writer__22269__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__21670__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__21670__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__21670__auto__)){
return or__21670__auto__;
} else {
...
var G__23276 = o;
(G__23276[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_23280 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_23280))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_23280)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__21658__auto__ = (node === document.activeElement);
if(and__21658__auto__){
var and__21658__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
if(cljs.core.truth_(and__21658__auto____$1)){
return (typeof value === 'string') && (typeof node_value === 'string');
} else {
return and__21658__auto____$1;
}
} else {
...
if(cljs.core.truth_((function (){var and__21658__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__23283 = jsprops;
(G__23283["defaultValue"] = value);

(G__23283["onChange"] = ((function (G__23283,v,value,on_change){
return (function (p1__23281_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__23281_SHARP_);
});})(G__23283,v,value,on_change))
);
...
var vec__23285 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__23285,(0),null);
var id = cljs.core.nth.call(null,vec__23285,(1),null);
var class$ = cljs.core.nth.call(null,vec__23285,(2),null);
...
var temp__4659__auto__ = (function (){var G__23289 = cljs.core.meta.call(null,v);
if((G__23289 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23289);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__23291_23292 = v;
var G__23291_23293__$1 = (((G__23291_23292 == null))?null:reagent.impl.template.key_from_vec.call(null,G__23291_23292));
if((G__23291_23293__$1 == null)){
} else {
(jsprops["key"] = G__23291_23293__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__23296 = cljs.core.meta.call(null,argv);
if((G__23296 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__23296);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__23297 = (((jsprops == null))?{}:jsprops);
(G__23297["key"] = key);
...
var G__23298 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__23298;
continue;
}
} else {
...
var n__22573__auto___23299 = a.length;
var i_23300 = (0);
while(true){
if((i_23300 < n__22573__auto___23299)){
(a[i_23300] = reagent.impl.template.as_element.call(null,(a[i_23300])));

var G__23301 = (i_23300 + (1));
i_23300 = G__23301;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__22573__auto___23302 = a.length;
var i_23303 = (0);
while(true){
if((i_23303 < n__22573__auto___23302)){
var val_23304 = (a[i_23303]);
if((cljs.core.vector_QMARK_.call(null,val_23304)) && ((reagent.impl.template.key_from_vec.call(null,val_23304) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23303] = reagent.impl.template.as_element.call(null,val_23304));

var G__23305 = (i_23303 + (1));
i_23303 = G__23305;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__21658__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__21658__auto__){
return (ctx["no-key"]);
} else {
return and__21658__auto__;
...
var G__23307 = (cljs.core.count.call(null,argv) - first_child);
switch (G__23307) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__23307){
...
//# sourceMappingURL=template.js.map?rel=1457989971452