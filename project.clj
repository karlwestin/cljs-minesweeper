(defproject cljs-minesweeper "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "cljs-minesweeper.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main cljs-minesweeper.server
  ...
  :cljsbuild {:builds
              {:app
               {:source-paths ["src/cljs" "src/cljc"]
                ...
                ;; :figwheel {:on-jsload "cljs-minesweeper.core/on-figwheel-reload"}

                :compiler {:main cljs-minesweeper.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/cljs_minesweeper.js"
